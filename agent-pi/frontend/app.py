...
from routes.auth_routes import register_routes, login_routes
from routes.dashboard_routes import dashboard_routes
from routes.booking_routes import booking_routes
from routes.eng_dashboard_routes import eng_dashboard_routes
...
class ScooterWebApp:
    ...
    def setup_routes(self):
        ...
        booking_routes(self.app)
        eng_dashboard_routes(self.app)
